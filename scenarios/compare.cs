...
public class CompareTest
{
    ...
    public void Emit(Machine machine)
    {
        ...
        string emittedDir = Path.Combine(AppContext.BaseDirectory, "emitted", "compare", refDir);
        Directory.CreateDirectory(emittedDir);
        File.WriteAllBytes(Path.Combine(emittedDir, "compare.obj"), emitted);
    ...
    static byte[] EmitObj(Machine machine)
    {
        ...
        // ─── Emit IL for compare ──────────────────────────────────────────
        {
            ...
            bodyEncoder.AddMethodBody(compareMethod, "?compare@@$$J0YAHHH@Z", enc,
        ...
        ClrIjw.EmitNepMachinery(machine, is32, ptrSize, symPrefix, coffHeader, symtab,
            ...
            MetadataTokens.GetToken(compareMethod), "compare", "?compare@@$$J0YAHHH@Z");
        ClrIjw.EmitNepMachinery(machine, is32, ptrSize, symPrefix, coffHeader, symtab,
            dataStreamBuilder, dataRelocBuilder, nepStreamBuilder, nepRelocBuilder,
            ilFixupStreamBuilder, ilFixupRelocBuilder,
