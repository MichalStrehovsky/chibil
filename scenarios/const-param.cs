...
public class ConstParamTest
{
    ...
    static byte[] EmitObj(Machine machine)
    {
        ...
        // ─── Emit IL for sum_array ────────────────────────────────────────
        {
            ...
            bodyEncoder.AddMethodBody(sumArrayMethod, "?sum_array@@$$J0YMHPBHH@Z", enc,
        ...
        // ─── Emit IL for read_volatile ────────────────────────────────────
        {
            ...
            bodyEncoder.AddMethodBody(readVolMethod, "?read_volatile@@$$J0YMHPCH@Z", enc,
