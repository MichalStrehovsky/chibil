...
public class IncDecTest
{
    ...
    public void Emit(Machine machine)
    {
        ...
        string emittedDir = Path.Combine(AppContext.BaseDirectory, "emitted", "incdec", refDir);
        Directory.CreateDirectory(emittedDir);
        File.WriteAllBytes(Path.Combine(emittedDir, "incdec.obj"), emitted);
    ...
    static byte[] EmitObj(Machine machine)
    {
        ...
        ClrIjw.EncodeCdeclI4Return(postIncRetEnc, callConvCdeclRef);
        ...
        ClrIjw.EncodeCdeclI4Return(preIncRetEnc, callConvCdeclRef);
        ...
        ClrIjw.EncodeCdeclI4Return(compAddRetEnc, callConvCdeclRef);
        ...
        ClrIjw.EncodeCdeclI4Return(compSubRetEnc, callConvCdeclRef);
        ...
        ClrIjw.EncodeCdeclI4Return(compMulRetEnc, callConvCdeclRef);
        ...
        ClrIjw.EncodeCdeclI4Return(compShlRetEnc, callConvCdeclRef);
        ...
        ClrIjw.EncodeCdeclVoidReturn(ptrPostIncRetEnc, callConvCdeclRef);
        ...
        // ─── Emit IL for post_inc ─────────────────────────────────────────
        {
            ...
            bodyEncoder.AddMethodBody(postIncMethod, "?post_inc@@$$J0YAHH@Z", enc,
        ...
        // ─── Emit IL for pre_inc ──────────────────────────────────────────
        {
            ...
            bodyEncoder.AddMethodBody(preIncMethod, "?pre_inc@@$$J0YAHH@Z", enc,
        ...
        // ─── Emit IL for compound_add ─────────────────────────────────────
        {
            ...
            bodyEncoder.AddMethodBody(compAddMethod, "?compound_add@@$$J0YAHHH@Z", enc,
        ...
        // ─── Emit IL for compound_sub ─────────────────────────────────────
        {
            ...
            bodyEncoder.AddMethodBody(compSubMethod, "?compound_sub@@$$J0YAHHH@Z", enc,
        ...
        // ─── Emit IL for compound_mul ─────────────────────────────────────
        {
            ...
            bodyEncoder.AddMethodBody(compMulMethod, "?compound_mul@@$$J0YAHHH@Z", enc,
        ...
        // ─── Emit IL for compound_shl ─────────────────────────────────────
        {
            ...
            bodyEncoder.AddMethodBody(compShlMethod, "?compound_shl@@$$J0YAHHH@Z", enc,
        ...
        // ─── Emit IL for ptr_post_inc ─────────────────────────────────────
        {
            ...
            bodyEncoder.AddMethodBody(ptrPostIncMethod, $"?ptr_post_inc@@$$J0YAXP{e}AP{e}AH@Z", enc,
