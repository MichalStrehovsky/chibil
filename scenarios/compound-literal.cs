...
public class CompoundLiteralTest
{
    ...
    public void Emit(Machine machine)
    {
        ...
        string emittedDir = Path.Combine(AppContext.BaseDirectory, "emitted", "compound-literal", refDir);
        Directory.CreateDirectory(emittedDir);
        File.WriteAllBytes(Path.Combine(emittedDir, "compound-literal.obj"), emitted);
    ...
    static byte[] EmitObj(Machine machine)
    {
        ...
        ClrIjw.EncodeCdeclI4Return(sumPointRetEnc, callConvCdeclRef);
        ...
        // ─── Emit IL for sum_point ────────────────────────────────────────
        {
            ...
            bodyEncoder.AddMethodBody(sumPointMethod, $"?sum_point@@$$J0YAHP{e}AU_Point@@@Z", enc,
