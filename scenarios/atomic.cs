...
public class AtomicTest
{
    ...
    public void Emit(Machine machine)
    {
        ...
        string emittedDir = Path.Combine(AppContext.BaseDirectory, "emitted", "atomic", refDir);
        Directory.CreateDirectory(emittedDir);
        File.WriteAllBytes(Path.Combine(emittedDir, "atomic.obj"), emitted);
    ...
    static byte[] EmitObj(Machine machine)
    {
        ...
        ClrIjw.EncodeCdeclI4Return(xchgRetEnc, callConvCdeclRef);
        ...
        ClrIjw.EncodeCdeclI4Return(casRetEnc, callConvCdeclRef);
        // Param 1: Ptr CMOD_REQD(IsVolatile) I4
        ...
        // ─── Emit IL for atomic_xchg ──────────────────────────────────────
        {
            ...
            bodyEncoder.AddMethodBody(xchgMethod, $"?atomic_xchg@@$$J0YAHP{e}CHH@Z", enc,
        ...
        // ─── Emit IL for atomic_cas ───────────────────────────────────────
        {
            ...
            bodyEncoder.AddMethodBody(casMethod, $"?atomic_cas@@$$J0YAHP{e}CHHH@Z", enc,
