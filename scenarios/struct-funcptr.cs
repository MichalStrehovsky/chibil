...
public class StructFuncptrTest
{
    ...
    static byte[] EmitObj(Machine machine)
    {
        ...
        int unepDoubleOffset = dataStreamBuilder.Count;
        for (int i = 0; i < ptrSize; i++) dataStreamBuilder.WriteByte(0);
        symtab.AddDataClrToken("__unep@?double_it@@$$J0YAHH@Z", unepDoubleField, LogicalSection.Data, unepDoubleOffset, out _);
        ...
        var doubleBareSym = ClrIjw.EmitNepMachinery(machine, is32, ptrSize, symPrefix, coffHeader, symtab,
        ...
        new CoffRelocationEncoder(coffHeader, dataRelocBuilder).AddAddressRelocation(unepDoubleOffset, doubleBareSym);
