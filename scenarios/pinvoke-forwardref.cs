// Emits pinvoke-forwardref.obj — equivalent to MSVC's output for:
//   struct Mine;
...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        string sourceFile = Path.GetFullPath("pinvoke-forwardref.c");
        ...
        using var fs = File.Create("pinvoke-forwardref.obj");
