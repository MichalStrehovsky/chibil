...
public class StructTest
{
    ...
    public void Emit(Machine machine)
    {
        ...
        string emittedDir = Path.Combine(AppContext.BaseDirectory, "emitted", "struct", refDir);
        Directory.CreateDirectory(emittedDir);
        File.WriteAllBytes(Path.Combine(emittedDir, "struct.obj"), emitted);
    ...
    static byte[] EmitObj(Machine machine)
    {
        ...
        ClrIjw.EncodeCdeclI4Return(sumRetEnc, callConvCdeclRef);
        ...
        // ─── Emit IL for sum_struct ───────────────────────────────────────
        {
            ...
            bodyEncoder.AddMethodBody(sumStructMethod, $"?sum_struct@@$$J0YAHP{e}AU_MyStruct@@@Z", enc,
