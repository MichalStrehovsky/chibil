...
public class BitfieldTest
{
    ...
    public void Emit(Machine machine)
    {
        ...
        string emittedDir = Path.Combine(AppContext.BaseDirectory, "emitted", "bitfield", refDir);
        Directory.CreateDirectory(emittedDir);
        File.WriteAllBytes(Path.Combine(emittedDir, "bitfield.obj"), emitted);
    ...
    static byte[] EmitObj(Machine machine)
    {
        ...
        ClrIjw.EncodeCdeclI4Return(btRetEnc, callConvCdeclRef);
        ...
        // ─── Emit IL for bitfield_test ────────────────────────────────────
        {
            ...
            bodyEncoder.AddMethodBody(bitfieldTestMethod, "?bitfield_test@@$$J0YAHXZ", enc,
        ...
        ClrIjw.EmitNepMachinery(machine, is32, ptrSize, symPrefix, coffHeader, symtab,
            ...
            MetadataTokens.GetToken(bitfieldTestMethod), "bitfield_test", "?bitfield_test@@$$J0YAHXZ");
        ClrIjw.EmitNepMachinery(machine, is32, ptrSize, symPrefix, coffHeader, symtab,
            dataStreamBuilder, dataRelocBuilder, nepStreamBuilder, nepRelocBuilder,
            ilFixupStreamBuilder, ilFixupRelocBuilder,
