...
public class StaticLocalTest
{
    ...
    static byte[] EmitObj(Machine machine)
    {
        ...
        symtab.AddDataClrToken(symPrefix + "?A0x00000000.?count@?1??counter@@9@9", countField, LogicalSection.Bss, 0, out _);
        ...
        ClrIjw.EmitNepMachinery(machine, is32, ptrSize, symPrefix, coffHeader, symtab,
            ...
            MetadataTokens.GetToken(counterMethod), "counter", "?counter@@$$J0YAHXZ");
        ClrIjw.EmitNepMachinery(machine, is32, ptrSize, symPrefix, coffHeader, symtab,
            dataStreamBuilder, dataRelocBuilder, nepStreamBuilder, nepRelocBuilder,
            ilFixupStreamBuilder, ilFixupRelocBuilder,
