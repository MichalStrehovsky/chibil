...
public class BitwiseTest
{
    ...
    public void Emit(Machine machine)
    {
        ...
        string emittedDir = Path.Combine(AppContext.BaseDirectory, "emitted", "bitwise", refDir);
        Directory.CreateDirectory(emittedDir);
        File.WriteAllBytes(Path.Combine(emittedDir, "bitwise.obj"), emitted);
    ...
    static byte[] EmitObj(Machine machine)
    {
        ...
        ClrIjw.EncodeCdeclI4Return(bRetEnc, callConvCdeclRef);
        ...
        // ─── Emit IL for bitwise ──────────────────────────────────────────
        {
            ...
            bodyEncoder.AddMethodBody(bitwiseMethod, "?bitwise@@$$J0YAHHH@Z", enc,
        ...
        ClrIjw.EmitNepMachinery(machine, is32, ptrSize, symPrefix, coffHeader, symtab,
            ...
            MetadataTokens.GetToken(bitwiseMethod), "bitwise", "?bitwise@@$$J0YAHHH@Z");
        ClrIjw.EmitNepMachinery(machine, is32, ptrSize, symPrefix, coffHeader, symtab,
            dataStreamBuilder, dataRelocBuilder, nepStreamBuilder, nepRelocBuilder,
            ilFixupStreamBuilder, ilFixupRelocBuilder,
